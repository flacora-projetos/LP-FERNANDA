import { ArrowRight, BarChart3, CheckCircle2, TrendingUp, Users, Instagram, Linkedin } from 'lucide-react';
...
/**
 * Entrada acima da dobra: animação puramente CSS, executada no primeiro paint.
 * Não esconde nada por JS, então o conteúdo do topo conta para o LCP e fica
 * legível para crawlers que não executam JavaScript.
 */
function FadeInHero({ children, delay = 0, className = "" }: { children: ReactNode, delay?: number, className?: string }) {
  return (
    <div
...
/**
 * Revelação no scroll para o conteúdo abaixo da dobra.
 * O estado inicial escondido vive na classe `.js .reveal` — aplicada somente
 * quando o script inline do <head> confirma que há JavaScript. Sem JS, o bloco
 * já nasce visível.
 */
...
const FAQ_ITEMS = [
  {
    q: 'O que é gestão de tráfego pago para e-commerce?',
    a: 'Gestão de tráfego pago para e-commerce é o trabalho de planejar, executar e otimizar campanhas de anúncios para levar o público certo até a loja virtual. Na prática, envolve estratégia de funil, definição de público, direcionamento de criativos, controle de orçamento e leitura de dados — com o objetivo de transformar investimento em venda de forma previsível, e não em picos isolados de faturamento.',
  },
  {
    q: 'Qual a diferença entre gestão de tráfego e só subir campanhas?',
    a: 'Subir campanha é execução; gestão é método. A gestão parte do funil inteiro — o que acontece antes do clique, na conversão dentro da loja e depois da venda. Quando a estrutura não está clara, aumentar a verba apenas acelera os gargalos que já existiam, e o resultado continua dependendo de tentativa e erro.',
  },
  {
    q: 'Para quem esse serviço é indicado?',
    a: 'Para e-commerces com produtos próprios que já vendem online e querem crescer com estrutura. Faz sentido principalmente para quem sente que o crescimento ficou instável, para quem decide onde investir no achismo e para quem procura uma parceria com método — não apenas alguém que executa campanha no gerenciador.',
  },
  {
    q: 'Como funciona o início do trabalho?',
    a: 'O primeiro passo é o diagnóstico: mapear os gargalos de tráfego, conversão e retenção antes de mexer na verba. Em seguida vem a estratégia de campanhas baseada na jornada do cliente e, depois, a otimização contínua, com reports semanais e reuniões estratégicas para acompanhar os números.',
  },
  {
    q: 'Em quanto tempo aparecem os resultados?',
    a: 'Depende do estágio da loja, do histórico de dados da conta e do investimento disponível. Por isso o trabalho começa pelo diagnóstico, e não por uma promessa de prazo: entender onde estão os gargalos é o que define quanto tempo leva para o funil sustentar um crescimento consistente.',
  },
];
...
export default function App() {
  ...
  return (
    <div className="min-h-screen selection:bg-brand-light/30 relative">
      ...
      <section className="relative overflow-hidden pt-32 pb-16 md:pt-40 md:pb-24 lg:pt-48 lg:pb-32">
        <div className="mx-auto max-w-7xl px-6 md:px-12">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-8 items-center">
            <FadeInHero className="max-w-2xl">
            ...
            <FadeInHero delay={0.2} className="relative mx-auto w-full max-w-md lg:max-w-none">
              ...
              <div className="aspect-[4/5] overflow-hidden rounded-2xl bg-surface/50 shadow-sm transition-transform duration-700 hover:scale-[1.01]">
                <picture>
                  <source
                    type="image/webp"
                    srcSet="/img/fernanda-cora-gestao-trafego-ecommerce-500.webp 500w, /img/fernanda-cora-gestao-trafego-ecommerce-1000.webp 1000w"
                    sizes="(min-width: 1024px) 45vw, 100vw"
                  />
                  <img
                    src="/img/fernanda-cora-gestao-trafego-ecommerce-1000.jpg"
                    srcSet="/img/fernanda-cora-gestao-trafego-ecommerce-500.jpg 500w, /img/fernanda-cora-gestao-trafego-ecommerce-1000.jpg 1000w"
                    sizes="(min-width: 1024px) 45vw, 100vw"
                    width={1000}
                    height={1250}
                    alt="Fernanda, gestora de tráfego pago para e-commerce, durante uma pausa para o café"
              ...
              <div className="animate-float absolute -bottom-6 -left-6 rounded-2xl bg-white p-6 shadow-xl w-64 border border-gray-100">
            ...
            {[
              ...
              <Fragment key={index}>
                <FadeIn delay={0.1 * index}>
                  <div className="group flex h-full items-start gap-4 rounded-2xl bg-white/5 p-6 border border-white/10 hover:border-brand-light/30 hover:bg-white/10 hover:-translate-y-1 transition-all duration-300 shadow-sm hover:shadow-md">
                    <CheckCircle2 className="h-6 w-6 shrink-0 text-brand mt-0.5 transition-transform duration-300 group-hover:scale-110 group-hover:text-brand-light" aria-hidden="true" />
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-3 relative isolate max-w-5xl mx-auto">
            ...
            <FadeIn delay={0.1} className="relative z-10 flex flex-col items-center text-center group">
              ...
              <h3 className="mb-3 font-sans text-sm font-bold uppercase tracking-wider text-brand">1. Diagnóstico</h3>
            ...
            <FadeIn delay={0.2} className="relative z-10 flex flex-col items-center text-center group">
              ...
              <h3 className="mb-3 font-sans text-sm font-bold uppercase tracking-wider text-brand">2. Estratégia</h3>
              <p className="text-ink/90 leading-relaxed max-w-[280px]">
            ...
            <FadeIn delay={0.3} className="relative z-10 flex flex-col items-center text-center group">
              ...
              <h3 className="mb-3 font-sans text-sm font-bold uppercase tracking-wider text-brand">3. Otimização</h3>
              <p className="text-ink/90 leading-relaxed max-w-[280px]">
            ...
            <FadeIn>
              <div className="aspect-square overflow-hidden rounded-full max-w-[400px] mx-auto border-8 border-surface shadow-md bg-surface/50 transition-transform duration-700 hover:scale-[1.02]">
                <picture>
                  <source
                    type="image/webp"
                    srcSet="/img/fernanda-cora-especialista-trafego-pago-400.webp 400w, /img/fernanda-cora-especialista-trafego-pago-800.webp 800w"
                    sizes="(min-width: 768px) 400px, 100vw"
                  />
                  <img
                    src="/img/fernanda-cora-especialista-trafego-pago-800.jpg"
                    srcSet="/img/fernanda-cora-especialista-trafego-pago-400.jpg 400w, /img/fernanda-cora-especialista-trafego-pago-800.jpg 800w"
                    sizes="(min-width: 768px) 400px, 100vw"
                    width={800}
                    height={800}
                    alt="Fernanda analisando dados de campanhas de tráfego pago no notebook"
      ...
      <section className="py-24 md:py-32">
        <div className="mx-auto max-w-4xl px-6 md:px-12">
          ...
          <FadeIn className="mb-24 rounded-3xl bg-[#EDE9DF] p-8 md:p-12">
            <h2 className="mb-4 font-display text-2xl font-bold leading-tight md:text-3xl text-ink">
      ...
      <section id="perguntas-frequentes" className="bg-[#EDE9DF] py-24 md:py-32 rounded-tr-[4rem] rounded-tl-[4rem]">
          ...
          <div className="divide-y divide-black/10">
            {FAQ_ITEMS.map((item, i) => (
              <Fragment key={item.q}>
                <FadeIn delay={0.05 * i}>
                  <div className="py-7">
                    <h3 className="mb-3 font-display text-xl font-bold leading-snug text-ink md:text-2xl">
                      {item.q}
                    </h3>
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-12">
          ...
          <div className="mt-10 flex flex-col md:flex-row items-center justify-between gap-6 text-sm text-surface/40">
            ...
            <div className="flex items-center gap-6">
              <a href="https://www.instagram.com/nandacora/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Instagram de @nandacora">
                <Instagram className="h-5 w-5" aria-hidden="true" />
              </a>
              <a href="https://www.tiktok.com/@nandacora" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="TikTok de @nandacora">
                <TikTokIcon className="h-5 w-5" />
              </a>
              <a href="https://www.linkedin.com/in/nandacora/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="LinkedIn de @nandacora">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="animate-pop-in fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl transition-transform hover:scale-110 active:scale-95"
        aria-label="Falar com a Fernanda no WhatsApp"
      >
